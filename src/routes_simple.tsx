...
function RoutesSimple() {
  ...
  const hasAccess = useCallback(
    (module: string) =>
      !!userData?.role?.permissions?.find((e: any) =>
  ...
  useEffect(() => {
    ...
    if (context?.loginUserData && context?.loginUserData?.role_name) {
      setUserData({ ...context?.loginUserData });
      console.log("@@@ USER DATA: ", userData); // Update state when data is available
    }
  }, [context]);
  return (
    <>
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            {hasAccess("batches") && (
              <Route
                path="batches/collections/:batchNo/:id"
            ...
            {hasAccess("delivery") && (
              <Route
                path="/dashboard/delivery/otp_hold/:invoice_id"
                element={<OTPHOLD />}
              />
            )}
            ...
            {hasAccess("delivery") && (
              <Route
                path="/dashboard/delivery/payment_collection/:invoice_id"
            ...
            {hasAccess("delivery") && (
              <Route
                path="/dashboard/delivery/report/:batchNo/:id"
            ...
            {hasAccess("collection") && (
              <Route
                path="/dashboard/collection/otp_hold/:invoice_id"
                element={<OTPHOLD />}
              />
            )}
            ...
            {hasAccess("collection") && (
              <Route
                path="/dashboard/collection/payment_collection/:invoice_id"
                element={<PaymentCollection />}
              />
            )}
            ...
            {hasAccess("collection") && (
              <Route
                path="/dashboard/collection/report/:batchNo/:id"
                element={<DeliveryReports />}
              />
            )}
