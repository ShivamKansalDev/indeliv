...
const Login = () => {
  ...
  const methods = useForm({
    ...
    defaultValues: {
      email: context?.emailOrPhone, // Set your default value here
    },
  });
    ...
    <div className="login-page">
      <LogoForm
        ...
        footer={
          <div className="d-flex align-items-center flex-column text-center">
            ...
            <button
              type="button"
              className="rounded btn btn-secondary google-button"
            >
      ...
      >
        ...
        <div className="forgot form-group form-check d-flex justify-content-between align-items-center mx-0 px-0">
          ...
          <Link to="/forgot-password" onClick={() => context?.setEmailOrPhone(methods.getValues('email'))} className="text12" style={{ color: "#0d6efd" }}>
            Forgot password?
          </Link>
        </div>
