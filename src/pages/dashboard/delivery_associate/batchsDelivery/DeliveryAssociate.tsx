            ...
            batch?.batch_number &&
              ...
              <>
                <div className="delivery-details-component">
                  <div className="nav-header-delivery bg-pure-white">
                    <div
                              ...
                              showReportButton ? (
                                ...
                                (
                                  <OverlayTrigger placement="bottom" overlay={(props) => (
                                    <Tooltip {...props} >
                                      {pathname.includes('delivery') ? 'Report can be generated once all invoices are delivered.' : 'Report can be generated once all invoices are covered.'}
                                    </Tooltip>
                                  )}>
                                    <button
            ...
            <Collections invoiceMode={true}/>
                ...
                <div className=" payment-footer-mob-delivery mobile-only w-100" >
                  {showMsg ? <div className="payment_report_msg text-center" >
                    {pathname.includes('delivery') ? 'Report can be generated once all invoices are delivered.' : 'Report can be generated once all invoices are covered.'} <CloseX onClick={() => setshowMsg(false)} />
                  </div> : <></>}
