          ...
          {menus?.map((menu: any, index: number) => (
            <li key={`${index}`} className="nav-item" onClick={() => {
              ...
              <div>
                {(menu?.name === "Employees")? (
                  <>
                    <Link className={`nav-link justify-content-between d-flex sidebar-link ${location.pathname.startsWith("/dashboard/employees") ? 'active' : menu?.name == "Employees" ? location.pathname.startsWith("/dashboard/employees") ? 'active' : '' : ''}`}
                    to={menu?.link}>
                ...
                (
                  ...
                  <Link className={`nav-link d-flex sidebar-link ${location.pathname.startsWith(menu?.link) ? 'active' : menu?.name == "Batches" ? location.pathname.startsWith('/dashboard/batch') ? 'active' : '' : ''} ${menu?.name == "Logs" ? 'audit-sidebar-btn' : ''}`}
                  to={menu?.link}>
                    <img
                      src={menu?.icon(location.pathname.startsWith(menu.link) ? true : menu?.name == "Batches" ? location.pathname.startsWith('/dashboard/batch') ? true : false : false)}
                      alt={menu?.name}
