...
export default function PaymentsList() {
  ...
  return (
    <div className="payments-list-component">
      <div className="nav-header">
        ...
        <div className="right-bar bg-pure-white">
          ...
          <div className="mobile-only">
            <button className="btn btn-light" style={{ background: "#EAECF0", padding: '10px 12px', borderRadius: '10px' }} onClick={() => setShowAddPaymentModal(true)}>
              <CircleFadingPlus />
            </button>
          </div>
      ...
      <div className="payments-list-content bg-pure-white">
        <Outlet
          context={{
            showAddPaymentModal,
