...
export function BatchProgress({totalCount, completedCount, batchStatus}: {
  ...
  return (
    <span>
      <ProgressBar className={'batch-progress d-inline-flex p-6'} style={{ backgroundColor: batchStatus === 'completed' ? 'lightgreen' : 'lightyellow' }} now={completedCount} max={totalCount}
