    ...
    <Modal show={showManageModal} onHide={handleClose} centered>
      <div className=" p-3">
        <div className="d-flex justify-content-center w-100">
          <Modal.Title className="generic_modal_title">Manage Vehicle Type</Modal.Title>
        </div>
        {categoryOne && (
          <div className="mt-3">
                  ...
                  if(item.category === "2 Wheeler"){
                    return (
                      <div 
                        ...
                        >
                          <img src={`/assets/Icon/${item.name}.svg`} alt="scooter" />
                          <span>{item.name}</span>
                          <input
                            type="checkbox"
                            ...
                            onChange={() => {
                              const updateList = manageVehicle.map((subItem) => {
                                return {
                                  ...subItem,
                                  checked: (item.id === subItem.id)? !subItem.checked : subItem.checked
                                }
                              })
